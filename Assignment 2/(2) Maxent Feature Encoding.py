...
encoding0 = maxent.TypedMaxentFeatureEncoding.train(trainFeaturesets0, count_cutoff=3, alwayson_features=True)

classifier0 = maxent.MaxentClassifier.train(trainFeaturesets0, bernoulli=False, encoding=encoding0, trace=0)
...
encoding1 = maxent.TypedMaxentFeatureEncoding.train(trainFeaturesets1, count_cutoff=3, alwayson_features=True)
classifier1 = maxent.MaxentClassifier.train(trainFeaturesets1, bernoulli=False, encoding=encoding1, trace=0)
...
encoding2 = maxent.TypedMaxentFeatureEncoding.train(trainFeaturesets2, count_cutoff=3, alwayson_features=True)
classifier2 = maxent.MaxentClassifier.train(trainFeaturesets2, bernoulli=False, encoding=encoding2, trace=0)
...
encoding3 = maxent.TypedMaxentFeatureEncoding.train(trainFeaturesets3, count_cutoff=3, alwayson_features=True)
classifier3 = maxent.MaxentClassifier.train(trainFeaturesets3, bernoulli=False, encoding=encoding3, trace=0)
...
encoding4 = maxent.TypedMaxentFeatureEncoding.train(trainFeaturesets4, count_cutoff=3, alwayson_features=True)
classifier4 = maxent.MaxentClassifier.train(trainFeaturesets4, bernoulli=False, encoding=encoding4, trace=0)
