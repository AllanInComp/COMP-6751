...
classifier0 = nltk.NaiveBayesClassifier.train(trainFeaturesets0)
...
print('\n\n\n')
classifier0.show_most_informative_features(10)
i=0
...
classifier1 = nltk.NaiveBayesClassifier.train(trainFeaturesets1)
...
classifier2 = nltk.NaiveBayesClassifier.train(trainFeaturesets2)
...
classifier3 = nltk.NaiveBayesClassifier.train(trainFeaturesets3)
...
print('Precision for pipeline with stemming, POS tagging and removing stop words ----> ', precision3)
print('Recall for pipeline with stemming, POS tagging and removing stop words ---> ', recall3)
print('F-score for pipeline with stemming, POS tagging and removing stop words ---> ', 2*precision3*recall3/(precision3+recall3))
print('Accuracy for pipeline with stemming, POS tagging and removing stop words --->', (truePositive + trueNegative)/len(actual3))
print('\n\n\n')
...
classifier4 = nltk.NaiveBayesClassifier.train(trainFeaturesets4)
