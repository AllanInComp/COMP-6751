...
classifier0 = nltk.DecisionTreeClassifier.train(trainFeaturesets0)
...
classifier1 = nltk.DecisionTreeClassifier.train(trainFeaturesets1)
...
classifier2 = nltk.DecisionTreeClassifier.train(trainFeaturesets2)
...
classifier3 = nltk.DecisionTreeClassifier.train(trainFeaturesets3)
...
classifier4 = nltk.DecisionTreeClassifier.train(trainFeaturesets4)
